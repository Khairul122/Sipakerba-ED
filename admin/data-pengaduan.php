            ...
            <tbody align="center">
              ...
              foreach ($data as $d):
                ...
                <tr>
                  ...
                  <td><?= $d['saran']; ?></td>
                  <td><?= $d['tgl_lapor']; ?></td>
                  <td><a href="detail-pengaduan.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-outline-info mr-2"
                      style="font-size: 15px; width: 80px;"><i class="fas fa-search mr-1"></i>Detail</a>
                    <a href="delete-pengaduan.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-outline-danger"
