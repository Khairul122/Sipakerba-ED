            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-2">
                  ...
                  <input type="text" name="id" id="id" class="form-control mb-3 bg-transparent" style="cursor: default;"
                    value="<?= $d['id']; ?>" readonly>
                </div>
                <div class="col-md-2">
                  <label for="tgl">Tanggal Pengaduan :</label>
                  <input type="text" name="tgl" id="tgl" class="form-control mb-3 bg-transparent" style="cursor: default;"
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <textarea name="kritik" id="kritik" class="form-control mb-3 bg-transparent" style="cursor: default;"
                    ><?= $d['kritik']; ?></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-8">
                  ...
                  <textarea name="saran" id="saran" class="form-control mb-3 bg-transparent" style="cursor: default;"
                    ><?= $d['saran']; ?></textarea>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-8 mt-2">
                  ...
                  <textarea name="ket_petugas" id="ket_petugas"
                    class="form-control mb-2"><?= $d['ket_petugas']; ?></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-8 mt-2">
